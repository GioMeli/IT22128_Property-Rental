...
const sampleProperties = [
  { id: 101, name: "Sample Apartment", location: "Downtown", cost: "$1200", bedrooms: 2 },
  { id: 102, name: "Luxury Condo", location: "Uptown", cost: "$2200", bedrooms: 3 },
  { id: 103, name: "Cozy Studio", location: "Midtown", cost: "$900", bedrooms: 1 },
  { id: 104, name: "Spacious Loft", location: "City Center", cost: "$1800", bedrooms: 2 },
  { id: 105, name: "Modern House", location: "Suburbs", cost: "$2500", bedrooms: 4 },
  { id: 106, name: "Classic Villa", location: "Harbor", cost: "$3000", bedrooms: 5 },
  { id: 107, name: "Budget Flat", location: "Riverside", cost: "$800", bedrooms: 1 },
  { id: 108, name: "Penthouse Suite", location: "Market District", cost: "$3500", bedrooms: 3 },
  { id: 109, name: "Eco Home", location: "Greenwich", cost: "$1600", bedrooms: 2 },
  { id: 110, name: "Historic House", location: "Old Town", cost: "$2000", bedrooms: 3 }
];
